...
<div class="flex flex-col gap-2 items-center mx-auto p-2">
	<button
	...
	<p>About yourself</p>
	<textarea
		class="sub-btn rounded-md w-full h-32"
	...
	{#if pending}
		<Spinner />
	{:else}
		<button on:click={update} class="main-btn mx-auto mt-5"> Update Profile </button>
	{/if}
</div>
